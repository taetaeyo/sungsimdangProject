...
<meta property="og:image" content="https://www.sungsimdangmall.co.kr/data/sungsimdang/imgSNS.gif?v=2022-01-05 오후 8:50:40">
<meta property="og:url" content="https://www.sungsimdangmall.co.kr">
<link rel="SHORTCUT ICON" href="https://www.sungsimdangmall.co.kr/data/sungsimdang/favicon.ico?1641415840" />
   ...
   <div class="collection">
       ...
       <div class="mdProductWrap">    
           <div class="mdProductBox">  
               <ul>
               		<c:forEach var="dto" items="${spelist}">
               		<li>
                            ...
                            <span class="collectTitTxt"><a href='/product/content.asp?prd_code=${dto.prd_code}' ><span style="">
                             ...
                             <div class="numValue">
                                ...
                                <span class="pri">${ dto.prd_prc } <span class='mwon'>원</span></span>
                                   <div class="btn cart" onclick="view_list_cart('${dto.prd_code}')"><img src='https://www.sungsimdangmall.co.kr/data/sungsimdang/banner/cart2.png' border=0></div>
                            </div>
                        </div>
                   </li>
                   </c:forEach>
...
<style type="text/css">
    ...
    .middle_banner_wrap .middle_bannerBox {width: 100%; height: 100%; max-width: 1280px; margin: 0 auto;}
    .middle_banner_wrap img{width: 100%;}
</style>
<!--// 탬플릿 // 탑탑베너 -->
<div class="middle_banner_wrap">
    <div class="middle_bannerBox">
         <img src="data/sungsimdang/banner/big_host.jpg" alt="">
    </div>
   ...
   <div class="collection">
       ...
       <div class="dlProductWrap">    
           <div class="dlProductBox on">  
               <ul>
                   <c:forEach var="dto" items="${delilist}">
               		<li>
                        <p class="hide"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"></a></p>
                        <div class="img"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"><span class="bgimg" style="background:url(..${dto.img1}) no-repeat center center; background-size:cover; font-size:0; line-height:0;"></span></a></div>
                        <div class="collectTxtWrap" var="dto">
           ...
           <div class="dlProductBox">  
               <ul>
                   <c:forEach var="dto" items="${ktxlist}">
               		<li>
                        <p class="hide"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"></a></p>
                        <div class="img"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"><span class="bgimg" style="background:url(..${dto.img1}) no-repeat center center; background-size:cover; font-size:0; line-height:0;"></span></a></div>
                        <div class="collectTxtWrap" var="dto">
           ...
           <div class="dlProductBox">  
               <ul>
                   <c:forEach var="dto" items="${daelist}">
               		<li>
                        <p class="hide"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"></a></p>
                        <div class="img"><a href="/product/content.asp?prd_code=${dto.prd_code}"><img src="images\imgprd\bread\ssd_secial\010001001001.jpg" onError="this.onerror=null;this.src='/images/noimage.png';" class="tmplSquareImg"><span class="bgimg" style="background:url(..${dto.img1}) no-repeat center center; background-size:cover; font-size:0; line-height:0;"></span></a></div>
                        <div class="collectTxtWrap" var="dto">
...
<style type="text/css">
    .ssInsta.collectionWrap {padding: 0px 0px 60px 0px;}
    .ssInsta.collectionWrap .collection {width: 100%; max-width: 1280px; margin:0 auto;}
    .ssInsta.collectionWrap .collection .clTitleBox {height: 45px; margin-bottom: 40px;}
    .ssInsta.collectionWrap .collection .clTitle {font-size:40px; color: #683b28; display: inline-block; line-height: 45px; float:left; font-weight:500;}
    .ssInsta.collectionWrap .collection .clTitle img{margin-right: 15px; width: 36px; padding-bottom: 5px;}
    .ssInsta.collectionWrap .collection .clMoreBtn {line-height: 45px; float:right; margin-left: 30px; font-size: 16px;  position: relative;}
    .ssInsta.collectionWrap .collection .clMoreBtn a {color: #939598; transition: 0.2 ease;}
    .ssInsta.collectionWrap .collection .clMoreBtn a:hover {color: #000;}
    .ssInsta.collectionWrap .collection .fisProductWrap .fisProductBox ul {display: flex;justify-content: flex-start;}
    .ssInsta.collectionWrap .collection .fisProductWrap .fisProductBox ul li {width: 20%; margin-bottom: 30px; margin-left: 3%;}

    .ssInsta.collectionWrap .collection .fisProductWrap .fisProductBox ul li .img img{width: 100%;}
    .ssInsta.collectionWrap .collection .fisProductWrap .fisProductBox ul li:nth-child(1){margin-left: 0;}
</style>
<!--//템플릿 : 성심당 인스타그램  -->

<div class="ssInsta collectionWrap">
   <div class="collection">
       <div class="clTitleBox clfix">
           <h1 class="clTitle"><img src='https://www.sungsimdangmall.co.kr/data/sungsimdang/banner/insta_1.png' border=0>인스타그램</h1>
       ...
       <div class="fisProductWrap">    
           <div class="fisProductBox on">  
               <ul id="instar_box">
                  <li>
    					<div class="img"><a href='https://www.instagram.com/p/CYneDjsJwgb/'><img src="/data/sungsimdang/banner/main_insta05.JPG" alt=""></a>
    			  		</div>
    			  </li>
                  <li>
    					<div class="img"><a href='https://www.instagram.com/p/CYkuPYKqg_x/'><img src="/data/sungsimdang/banner/main_insta04.JPG" alt=""></a>
                  </div>
                  </li>
                  <li>
    					<div class="img"><a href='https://www.instagram.com/p/CYiYnZDpdrz/'><img src="/data/sungsimdang/banner/main_insta01.JPG" alt=""></a>
                  		</div>
    			  </li>
                  <li>
    					<div class="img"><a href='https://www.instagram.com/p/CYVbWQPqmNp/'><img src="/data/sungsimdang/banner/main_insta02.JPG" alt=""></a>
                  		</div>
    			  </li>
                  <li>
    					<div class="img"><a href='https://www.instagram.com/p/CYVbWQPqmNp/'><img src="/data/sungsimdang/banner/main_insta03.JPG" alt=""></a>
                  		</div>
                  </li>
               </ul>
           </div>
...
<script>
    ...
    //내용 없으면 li 삭제
    delImg('.ssInsta.collectionWrap .fisProductWrap ul li','');
    delImg('.ssInsta.collectionWrap .fisProductWrap .img','li');
</script></div>
<div>
<a name='M_1185'></a>
<!--템플릿 : 성심당 패밀리브랜드 인스타그램 -->
   ...
   <div class="collection">
       ...
       <div class="noticeRightWrap"> 
            <div class="noticeLeft">
                ...
                <ul>
                    <li><a href="/notice/notice.asp?board=notice&uid=970">※ 안내 ※  제품 가격인상.</a> <span>2021-12-31</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=969">크리스마스케익 예약(방문 및 배..</a> <span>2021-12-22</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=968">1:1 게시판 운영안내(크리스마스..</a> <span>2021-12-14</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=967">KTX특송 일부지역(마산역 및 호..</a> <span>2021-11-29</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=966">KTX특송 일부 영업소 임시 휴무..</a> <span>2021-08-02</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=965">코로나 확산에 따른 택배 제한 안..</a> <span>2021-07-28</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=964">주문 및 배송비 안내드립니다.</a> <span>2021-04-28</span></li>
                    <li><a href="/notice/notice.asp?board=notice&uid=963">상품리뷰 적립금 지급안내</a> <span>2021-02-19</span></li>
                </ul>
            </div>
       </div>
...
<div class="footer">
    ...
    <!-- <span style="" class="footCopyrightbtn" onclick="onopen();" valign="absmiddle">사업자정보확인</span> -->
            ...
            <div class="footlogo"><a href='default.asp' target=''><img src='https://www.sungsimdangmall.co.kr/data/sungsimdang/banner/ft_logo_2.png' border=0></a></div>
        </div>
    </div>
...
function portfolioAjax(page, categoryNum){
	...
	$.ajax({
		...
		<!-- Popup Script -->
		<script src="/main/popup_main.js"></script>
